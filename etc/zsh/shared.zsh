...
function _ls_home_dir_macos_clean() {
  ls -l --color=always $HOME | grep --color=always -Ev 'Applications|Clean|Creative Cloud Files|Desktop|Documents|Downloads|Google Drive|Library|Movies|Music|Notes|Pictures|Postman|Public|Remotes|Repositories|Shared|tmp|insta360|Screen Captures|Virtual Machines.localized' | grep --color=always -v 'total '
}
