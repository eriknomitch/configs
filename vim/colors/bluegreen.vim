...
if exists("g:bluegreen_transbg")
  ...
  " xreact colors
  hi DefPivot  ctermfg=Cyan guifg=Cyan ctermbg=none guibg=Black cterm=bold gui=bold term=bold
  hi DefMotion  ctermfg=Cyan guifg=Cyan ctermbg=none guibg=Black cterm=none gui=none term=none
  call matchadd("DefPivot", "defpivot")
  call matchadd("DefMotion", "defmotion")
  ...
  hi VertSplit    cterm=none ctermfg=White guifg=White     ctermbg=DarkGray guibg=Black
  hi Directory    ctermfg=Cyan guifg=Cyan      ctermbg=DarkBlue guibg=DarkBlue
  hi Visual       ctermfg=White guifg=White     ctermbg=DarkGray guibg=DarkGray cterm=underline gui=underline term=none
  hi Title        ctermfg=White guifg=White     ctermbg=DarkBlue guibg=DarkBlue
